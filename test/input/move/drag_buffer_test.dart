...
void main() {
  ...
  testWidgets('drag starts only when movement exceeds dragStartSlop', (
    tester,
  ) async {
    final node = RectNode(
      id: 'n1',
    ...
    expect(controller.debugMoveGestureBuildCount, 1);
    expect(node.position.dx, greaterThan(0));
