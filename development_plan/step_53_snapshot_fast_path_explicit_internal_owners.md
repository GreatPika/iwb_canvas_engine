...
1. `development_plan/contract_target_architecture.md` remains the source of
...
- `ARCHITECTURE.md`, `DEVELOPMENT_PLAN.md`, and
  `development_plan/contract_target_architecture.md` describe the final
