...
- `development_plan/step_49*.md`
- `development_plan/step_50*.md`
...
1. `DEVELOPMENT_PLAN.md` and the linked step docs describe one consistent
   post-step-`50` state.
2. `development_plan/model_target_architecture.md` is updated if, and only if,
