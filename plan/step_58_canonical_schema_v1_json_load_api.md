...
| `D10` Performance acceptance measures the new public JSON load API at 50k on the Xiaomi 22081283G manual reference contour, excludes first projection, and gates `schema_import_load_us < 574000`. | `Boundaries.Order Constraints`, Unit 7 | Benchmark manifest/probe tests, Xiaomi manual run, and required bridge report comparing old route and new route with no projection. |
...
### [x] Unit 7: Benchmark migration, Xiaomi bridge report, and acceptance gate
