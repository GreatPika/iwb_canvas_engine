...
2. `plan/contract_target_architecture.md` is the source of truth
...
2. `PLAN.md`, `plan/contract_target_architecture.md`,
...
Update `ARCHITECTURE.md`, `PLAN.md`,
`plan/contract_target_architecture.md`, and the linked step
