...
`plan/step_10_1_scene_view_pointer_router_owner_and_slot_contract.md`
...
`plan/step_10_2_pointer_event_admission_and_flush_lifecycle.md`
...
`plan/step_10_3_pointer_settings_transition_and_value_semantics.md`
