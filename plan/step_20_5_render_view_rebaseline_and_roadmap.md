...
- `plan/step_20_render_view_secondary_hotspots.md`
- `plan/step_20_4_residual_render_view_hotspot_closure.md`
- `plan/step_20_5_render_view_rebaseline_and_roadmap.md`
- `PLAN.md`
...
Обновить `PLAN.md` and `plan/step_20*.md` по
