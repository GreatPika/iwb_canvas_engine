...
`plan/step_08_1_mutation_op_contract_and_executor_boundary.md`
...
`plan/step_08_2_txn_apply_semantics_and_document_helpers.md`
...
`plan/step_08_3_scene_writer_executor_adoption.md`
...
`plan/step_08_4_scene_controller_commit_pipeline.md`
...
`plan/step_08_5_controller_commit_plan_and_branch_collapse.md`
...
`plan/step_08_6_executor_operation_family_cleanup.md`
...
`plan/step_08_7_txn_context_hot_path_primitives.md`
