...
- `plan/step_37_core_final_architecture.md`
- `plan/step_37_1_node_family_core_owner_decomposition.md`
- `plan/step_37_2_path_cache_and_mutable_geometry_owner_split.md`
- `plan/step_37_3_core_leaf_support_owner_finalization.md`
- `plan/step_37_4_core_final_architecture_closure.md`
...
3. `PLAN.md` and the step-`37` documents describe one consistent
...
Update `ARCHITECTURE.md`, `PLAN.md`, and the step-`37` documents to
...
- Green run of the listed verifications.
- `ARCHITECTURE.md`, `PLAN.md`, and the step-`37` documents reflect
