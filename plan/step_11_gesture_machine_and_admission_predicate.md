...
`plan/step_11_1_controller_pointer_entry_and_terminal_semantics.md`
...
`plan/step_11_2_controller_gesture_owner_and_lifecycle_reset.md`
...
`plan/step_11_3_interaction_eligibility_policy_owner.md`
...
`plan/step_11_4_move_session_policy_and_cancel_semantics.md`
...
`plan/step_11_5_draw_gesture_lifecycle_and_pending_line_cleanup.md`
...
`plan/step_11_6_selection_api_gesture_exclusivity.md`
