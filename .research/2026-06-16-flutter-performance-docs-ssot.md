...
- **Dependencies**: Searches found historical benchmark references in
  `.design/2026-06-05-p14-release-readiness-benchmarks.md`,
  `.design/2026-06-06-p14-benchmark-measurement-boundary.md`, and
  `.research/2026-06-06-pixel6-release-benchmark-hotspots.md`; those files are
