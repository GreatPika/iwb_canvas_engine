...
- **Description**: The runtime ownership composition-root tree lists
  ...
  (`.design/2026-05-28-p7-resource-session-resolver-lifecycle.md:155`,
  `.design/2026-05-28-p7-resource-session-resolver-lifecycle.md:158`).
- **Dependencies**: The main paint sequence enters an explicit resource-session
  ...
  (`.design/2026-05-28-p7-resource-session-resolver-lifecycle.md:162`).
...
- **Data flow**: The P9 design listed expected future files with the older names
  (`.design/2026-05-29-p9-frame-rendering-and-caches.md:265`,
  `.design/2026-05-29-p9-frame-rendering-and-caches.md:269`,
  `.design/2026-05-29-p9-frame-rendering-and-caches.md:270`,
  `.design/2026-05-29-p9-frame-rendering-and-caches.md:279`). The current graph
...
- **Inspected**: Directly named files were read completely:
  ...
  `.design/2026-05-29-p9-frame-rendering-and-caches.md`,
