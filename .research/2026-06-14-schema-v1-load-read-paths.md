...
- **Design pressure**: the canonical schema v1 JSON load design records the
  ...
  (`.design/2026-06-07-canonical-schema-v1-json-load-api.md:541`,
  `.design/2026-06-07-canonical-schema-v1-json-load-api.md:552`,
  `.design/2026-06-07-canonical-schema-v1-json-load-api.md:580`,
  `.design/2026-06-07-canonical-schema-v1-json-load-api.md:597`).
...
- `.design/2026-06-07-canonical-schema-v1-json-load-api.md:541` - prior design pressure around decoder materialization and separate runtime importer.
...
- Inspected contracts and design sources:
  ...
  `.design/2026-06-07-canonical-schema-v1-json-load-api.md`.
...
- The prior design states a 50k Xiaomi acceptance gate of
  ...
  (`.design/2026-06-07-canonical-schema-v1-json-load-api.md:641`,
