...
Coverage summary for context capsules and registries.
...
- `section_05_schema_v1_contract`: must_read=linked, donors=linked, diagrams=linked, tests=linked, guardrails=linked
