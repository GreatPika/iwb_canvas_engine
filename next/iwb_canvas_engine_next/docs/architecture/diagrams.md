...
Document path: `docs/architecture/diagrams.md`
Owns:
...
All diagrams below are required files under `docs/diagrams/` and must be regenerated when architecture changes.
