...
25. [x] **(#9) Tap/double-tap signals can be generated by a non-active pointer during an active gesture**
...
26. [x] **(#10) `SceneView` creates/recreates timers on every pointer sample (especially move)**
...
27. [x] **(#11) Double-tap tracking keyed by device kind instead of `pointerId` (multitouch bugs)**
