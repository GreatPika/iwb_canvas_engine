...
- [ ] [Шаг 13. Ужесточить guardrails и реестр инвариантов через подшаги 13.1-13.6](development_plan/step_13_guardrails_and_invariant_registry.md)
...
- [ ] [Шаг 13.4. Довести controller mutation, epoch invalidation и boundary-error rules до semantic AST guardrails](development_plan/step_13_4_semantic_ast_guardrails_for_mutation_epoch_and_boundary_errors.md)
