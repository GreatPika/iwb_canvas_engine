...
- [ ] [Шаг 17.3.1. Выровнять owner-а snapshot `instanceRevision` перед encode schema adoption](development_plan/step_17_3_1_snapshot_instance_revision_owner_alignment.md)
