...
- [ ] [Шаг 11.1. Зафиксировать controller pointer entry contract и canonical terminal semantics](development_plan/step_11_1_controller_pointer_entry_and_terminal_semantics.md)
