...
- [x] **Проверять инварианты *до* записи в `_store`**  
...
- [x] **Расширить store-инварианты до ловли сценовых порч**  
...
- [x] **Тест на “инварианты падают → _store не меняется”**  
...
- [x] **Перевести `actions` и `editTextRequests` на асинхронную доставку**  
...
- [x] **Обновить тесты интерактивного контроллера**  
...
- [x] **Обновить публичную документацию контракта событий**  
...
- [x] **Кэш `snapshot` по идентичности сцены**  
...
- [x] **Случайное тестирование транзакций (минимальный генератор сценариев)**  
