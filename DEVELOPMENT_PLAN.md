...
- [x] Переключение Move/Draw и инструментов.
- [x] Добавление тестовых объектов.
- [x] Панель управления стилем текста в example (размер, цвет, выравнивание).
- [x] Команды rotate/flip/delete/clear.
- [x] Палитры цветов, фон, сетка, камера по X.
- [x] Визуальная метка старта для двухтаповой линии.
