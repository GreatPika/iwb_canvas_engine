...
- [ ] [Шаг 13. Замкнуть non-regression tooling для import/public contracts, invariant proofs и coverage gates](development_plan/step_13_guardrails_and_invariant_registry.md)
