...
5. **[Открыто] Нормализация выделения ломает смысл `onlySelectable: false` (контракт API становится “полуработающим”)**
...
8. **[Открыто] Двойное клонирование сцены на транзакцию при изменениях (скорее производительность, но может стать проблемой на больших документах)**
