...
| --- | --- | --- |
| `public_package_boundary` | [Public package boundary](families/public_package_boundary.md) | `docs stale` |
| `contract_document_model_and_validated_fast_paths` | [Contract document model and validated fast paths](families/contract_document_model_and_validated_fast_paths.md) | `docs stale` |
| `import_build_materialization` | [Import build materialization](families/import_build_materialization.md) | `docs stale` |
| `serialization_and_schema` | [Serialization and schema](families/serialization_and_schema.md) | `docs stale` |
| `core_scene_graph_geometry_and_spatial_indexes` | [Core scene graph geometry and spatial indexes](families/core_scene_graph_geometry_and_spatial_indexes.md) | `docs stale` |
| `model_document_mutation_and_topology` | [Model document mutation and topology](families/model_document_mutation_and_topology.md) | `docs stale` |
...
| `render_frame_admission_and_caches` | [Render frame admission and caches](families/render_frame_admission_and_caches.md) | `docs stale` |
| `diagnostics_performance_and_debug_surfaces` | [Diagnostics performance and debug surfaces](families/diagnostics_performance_and_debug_surfaces.md) | `docs stale` |
