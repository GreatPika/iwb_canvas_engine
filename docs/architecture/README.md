...
the generated navigation that supports owner, subsystem, and diagram lookup.
...
5. `docs/architecture/architecture_graph.yaml`
6. `docs/diagrams/catalog.md`
...
- Current owners: `docs/indexes/by_owner.md`
