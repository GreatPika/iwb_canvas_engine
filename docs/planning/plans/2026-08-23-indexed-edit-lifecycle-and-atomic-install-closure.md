...
| CommitApplier branch closure | Unit 7 owner | `flutter test test/edit/selection_effect_commit_test.dart test/edit/net_no_op_edit_commit_test.dart` | Exit 0 with one prepared state, both install branches, pre-point rollback, and post-point retention exact |
