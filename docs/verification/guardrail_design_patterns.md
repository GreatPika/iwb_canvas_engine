...
| `resources.resolver_boundary_owned_by_surface_session` | `resolved_element_identity` | `behavioral_seam_test` | `derived from legacy pattern` | Block direct resolver calls from painters/frame/resource code outside SurfaceResourceSession and prove SurfaceResourceSession ownership. |
