...
| `release.benchmark_readiness` | device/manual references own performance comparison; public/runtime source cannot expose benchmark tooling, public integration names, benchmark route outside release policy, or benchmark-only production hooks |
