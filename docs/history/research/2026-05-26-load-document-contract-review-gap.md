...
phase guide, and durable diagrams (`docs/history/designs/2026-05-26-p6-load-document.md:443`,
`docs/history/designs/2026-05-26-p6-load-document.md:449`;
...
- **Location**: primary `docs/history/designs/2026-05-26-p6-load-document.md:443`;
  additional `docs/history/designs/2026-05-26-p6-load-document.md:488`,
  `docs/history/designs/2026-05-26-p6-load-document.md:510`.
- **Description**: The selected form says that after preparation succeeds,
  ...
  publication (`docs/history/designs/2026-05-26-p6-load-document.md:443`,
  `docs/history/designs/2026-05-26-p6-load-document.md:449`). The lock-required dependency
  order also places post-install pointer normalization and pending tap cleanup
  after store replacement plus runtime facts (`docs/history/designs/2026-05-26-p6-load-document.md:488`,
  `docs/history/designs/2026-05-26-p6-load-document.md:492`).
- **Dependencies**: The design's handoff repeats the same sequencing fact:
  ...
  or state publication (`docs/history/designs/2026-05-26-p6-load-document.md:765`,
  `docs/history/designs/2026-05-26-p6-load-document.md:768`). Its C4 diagram labels the
  interaction boundary as owning "Pre-install preview cleanup and post-install
  pointer cleanup" (`docs/history/designs/2026-05-26-p6-load-document.md:560`,
  `docs/history/designs/2026-05-26-p6-load-document.md:562`).
- **Data flow**: design selected form -> lock-required facts -> provisional data
  ...
  (`docs/history/designs/2026-05-26-p6-load-document.md:575`,
  `docs/history/designs/2026-05-26-p6-load-document.md:587`,
  `docs/history/designs/2026-05-26-p6-load-document.md:617`,
  `docs/history/designs/2026-05-26-p6-load-document.md:618`).
...
- `.agents/skills/change-contract-check/SKILL.md:145` - unsafe order is a blocking
  contract criterion.
- `docs/history/designs/2026-05-26-p6-load-document.md:443` - selected form begins the
  post-preparation runtime orchestration paragraph.
- `docs/history/designs/2026-05-26-p6-load-document.md:448` - selected form names post-install
  pointer-normalization/pending-tap cleanup.
- `docs/history/designs/2026-05-26-p6-load-document.md:510` - lock-required execution order
  starts.
- `docs/history/designs/2026-05-26-p6-load-document.md:765` - handoff constraints place
  interrupt/preview cleanup before install.
- `docs/history/designs/2026-05-26-p6-load-document.md:767` - handoff constraints place
...
- Superseded by commit `4d5d6544`: source inputs and implementation no longer all
  ...
  (`docs/history/designs/2026-05-26-p6-load-document.md:448`,
...
- This repository snapshot contains the workflow rules and resulting P6 design
  ...
  accepted `docs/history/designs/2026-05-26-p6-load-document.md`, the completed
