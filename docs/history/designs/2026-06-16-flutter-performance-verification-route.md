...
- `docs/history/research/2026-06-16-flutter-performance-docs-ssot.md` - factual research on
...
- `docs/history/research/2026-06-16-flutter-performance-docs-ssot.md:33` - no active
...
|---|---|---|---|
| D1 | The durable performance route owner is a new registered `docs/verification/performance.md` section. | `docs/README.md:23`, `docs/history/research/2026-06-16-flutter-performance-docs-ssot.md:33`, this design's Selected Form | `Boundaries.Source of Truth`, `Unit 1` docs registry and performance doc |
...
| D7 | Old benchmark registry/index/tooling routes remain retired. | `docs/tool/check_docs.dart:29`, `docs/tool/check_docs.dart:255`, `docs/history/research/2026-06-16-flutter-performance-docs-ssot.md:33` | `Out of Scope`, semantic search proof for no retired benchmark route |
...
- Evidence to cite:
  ...
  - `docs/history/designs/2026-06-16-flutter-performance-verification-route.md` Required
    Flutter Scenario Catalog
  - `docs/history/designs/2026-06-16-flutter-performance-verification-route.md` Selected
    Form
