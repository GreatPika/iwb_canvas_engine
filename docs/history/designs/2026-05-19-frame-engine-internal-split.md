...
design_question: "Design an internal split for FrameEngine using the existing research note docs/history/research/2026-05-19-frame-engine-internal-split.md, preserving the external FrameEngine/API surface while separating capture, ordinary paint planning, selection decoration, resource image binding, static background planning, and selected move supplement responsibilities."
---
...
- `docs/history/research/2026-05-19-frame-engine-internal-split.md` - supplied factual map
