...
design_question: "Design P8 geometry/spatial implementation from docs/history/research/2026-05-29-p8-geometry-spatial-readiness.md, including files, diagrams, docs, and smoke test scope."
---
...
- `docs/history/research/2026-05-29-p8-geometry-spatial-readiness.md` - confirmed P8 scope, existing read/touched/effect seams, graph metadata, required docs/tests/guardrails, diagnostics routing, and future consumer pressures.
