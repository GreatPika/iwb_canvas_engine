...
- `docs/history/research/2026-05-25-diagnostics-public-surface-guard.md` - records that the current diagnostics leak guard resolves the public API surface but selects diagnostics declarations through a private name predicate, and that the existing public API registry is a flat exported-name inventory without a diagnostics-specific list (`docs/history/research/2026-05-25-diagnostics-public-surface-guard.md:13`, `docs/history/research/2026-05-25-diagnostics-public-surface-guard.md:15`).
