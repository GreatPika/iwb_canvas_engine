...
design_question: "Create a maximally detailed architecture design for docs/implementation/p10_selection_and_move.md using docs/history/research/2026-06-01-p10-selection-and-move-readiness.md."
---
...
- `docs/history/research/2026-06-01-p10-selection-and-move-readiness.md`
...
- `docs/history/research/2026-06-01-p10-selection-and-move-readiness.md:13` through `docs/history/research/2026-06-01-p10-selection-and-move-readiness.md:21` find that public selection, pointer, preview, action, resolver, `SelectionKernel`, and runtime revision surfaces already exist.
- `docs/history/research/2026-06-01-p10-selection-and-move-readiness.md:23` through `docs/history/research/2026-06-01-p10-selection-and-move-readiness.md:31` find that staged load behavior and P9 frame preview paths already support selected-move main-scene rendering and marquee overlay rendering.
- `docs/history/research/2026-06-01-p10-selection-and-move-readiness.md:33` through `docs/history/research/2026-06-01-p10-selection-and-move-readiness.md:39` identify the main gap: no production `lib/src/interaction/`, no `InteractionEngine`, no cleanup coordinator, no pointer session/normalizer/state machines, no production action emission, and no `test/interaction/**`.
- `docs/history/research/2026-06-01-p10-selection-and-move-readiness.md:43` through `docs/history/research/2026-06-01-p10-selection-and-move-readiness.md:56` restate that P10 commits must go through `EditKernel` and reads must go through batched immutable query ports.
- `docs/history/research/2026-06-01-p10-selection-and-move-readiness.md:58` through `docs/history/research/2026-06-01-p10-selection-and-move-readiness.md:79` confirm existing direct selection API behavior and runtime rejection of document-mutating selection commands.
- `docs/history/research/2026-06-01-p10-selection-and-move-readiness.md:81` through `docs/history/research/2026-06-01-p10-selection-and-move-readiness.md:101` confirm that selection revision is separate from document/projection/spatial revision domains.
- `docs/history/research/2026-06-01-p10-selection-and-move-readiness.md:300` through `docs/history/research/2026-06-01-p10-selection-and-move-readiness.md:323` confirm selected-move main-frame and marquee overlay-frame proof already exists in P9.
- `docs/history/research/2026-06-01-p10-selection-and-move-readiness.md:325` through `docs/history/research/2026-06-01-p10-selection-and-move-readiness.md:358` identify current interaction contract and diagram requirements.
- `docs/history/research/2026-06-01-p10-selection-and-move-readiness.md:360` through `docs/history/research/2026-06-01-p10-selection-and-move-readiness.md:394` identify legacy donor material and forbidden legacy package structures.
- `docs/history/research/2026-06-01-p10-selection-and-move-readiness.md:396` through `docs/history/research/2026-06-01-p10-selection-and-move-readiness.md:412` confirm `CanvasRuntime.tools`, `commands`, and `contextActionRequests` are currently placeholders and no production action emission exists.
