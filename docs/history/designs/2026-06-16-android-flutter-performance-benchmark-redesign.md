...
- `docs/history/research/2026-06-16-android-performance-hotspot-paths.md` - factual
...
- `docs/history/research/2026-06-16-android-performance-hotspot-paths.md:13` - current
...
- `docs/history/research/2026-06-16-android-performance-hotspot-paths.md:30` - current
...
- `docs/history/research/2026-06-16-android-performance-hotspot-paths.md:87` - the route
  ...
  conclusions.
- `docs/history/research/2026-06-16-android-performance-hotspot-paths.md:113` - current
...
- `docs/history/research/2026-06-16-android-performance-hotspot-paths.md:198` - current
...
- `docs/history/research/2026-06-16-android-performance-hotspot-paths.md:231` - current
...
- `docs/history/research/2026-06-16-android-performance-hotspot-paths.md:280` - current
...
- `docs/history/research/2026-06-16-android-performance-hotspot-paths.md:333` - current
...
|---|---|---|---|
| Optimization work needs clearer before/after evidence for large Android scenarios. | `docs/history/research/2026-06-16-android-performance-hotspot-paths.md:13` | Separates setup, warm, and steady phases and records repeated steady-state raw summaries. | Longer local release runs; no exact cross-device precision claim. |
...
| D2 | Change the catalog from one report key per scenario id to scenario groups with canonical `setup`, `warm`, `steady`, and `single` phase descriptors. | `docs/verification/performance.md:54`, `docs/history/research/2026-06-16-android-performance-hotspot-paths.md:13`, `example/lib/perf/performance_scenario.dart:107` | `Boundaries.Source of Truth`; docs unit; scenario descriptor unit; route contract test |
| D3 | Separate fixture/document setup from action cost for the seven redesigned groups. | `docs/history/research/2026-06-16-android-performance-hotspot-paths.md:113`, `docs/history/research/2026-06-16-android-performance-hotspot-paths.md:198`, `docs/history/research/2026-06-16-android-performance-hotspot-paths.md:231`, `docs/history/research/2026-06-16-android-performance-hotspot-paths.md:280`, `docs/history/research/2026-06-16-android-performance-hotspot-paths.md:333` | Scenario descriptor execution unit; phase catalog proof; generated artifact checker |
| D4 | Add warm and repeated steady-state variants for pan, selection move, marquee, eraser, and also repeat load/first-frame/export action groups for comparable before/after evidence. | `docs/verification/performance.md:115`, `docs/history/research/2026-06-16-android-performance-hotspot-paths.md:87` | Docs statistical policy; route runner unit; checker repeat completeness proof |
...
| D7 | Before/after comparisons report raw repeats, median, and spread without threshold or device-independent precision claims. | `docs/verification/performance.md:115`, `docs/verification/release_gates.md:173`, `docs/history/research/2026-06-16-android-performance-hotspot-paths.md:30` | Verification strategy; comparison summary proof; source-of-truth docs |
...
|---|---|---|
| Owner-Level Fix | pass | The weakness is route-level measurement semantics, not one runtime subsystem; docs route ownership and current scenario helper mixing are shown by `docs/verification/performance.md:30` and `docs/history/research/2026-06-16-android-performance-hotspot-paths.md:13`. |
...
| Outcome-Proof Fit | pass | Direct outcomes and proof surfaces are listed in `Outcome-Proof Fit`; proxy-only claims such as subsystem CPU attribution or threshold precision are explicitly rejected by `docs/verification/performance.md:115` and `docs/history/research/2026-06-16-android-performance-hotspot-paths.md:30`. |
