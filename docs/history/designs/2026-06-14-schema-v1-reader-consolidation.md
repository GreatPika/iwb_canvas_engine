...
- `docs/history/research/2026-06-14-schema-v1-load-read-paths.md` - records the duplicated
...
- `docs/history/research/2026-06-14-schema-v1-load-read-paths.md:13` - current schema v1
  ...
  cleanup.
- `docs/history/research/2026-06-14-schema-v1-load-read-paths.md:25` - fast runtime load is
...
- `docs/history/research/2026-06-14-schema-v1-load-read-paths.md:37` - duplicated surface
...
- `docs/history/designs/2026-06-07-canonical-schema-v1-json-load-api.md:541` - prior design
...
- `docs/history/designs/2026-06-07-canonical-schema-v1-json-load-api.md:634` - prior design
...
- `docs/history/research/2026-06-14-schema-v1-load-read-paths.md:556` - research records a
...
| Future schema versions may add fields or element families. | `docs/contracts/codec_boundary.md:35`; `docs/history/research/2026-06-14-schema-v1-load-read-paths.md:37` | New fields go through one canonical reader owner and then through target sinks/builders. | Adding a future target sink still requires sink/builder tests, but not a second JSON traversal. |
...
|---|---|---|---|
| D1 | Schema v1 wire-format navigation and field admission get one codec-owned canonical reader seam. | `docs/history/research/2026-06-14-schema-v1-load-read-paths.md:37`; `docs/contracts/codec_boundary.md:35` | `Boundaries.Owner`; reader migration execution unit; structural no-duplicate-reader proof |
...
| D6 | Performance proof requires the existing fresh Xiaomi baseline as Change Contract input evidence and a final Xiaomi measurement during implementation. | `docs/history/designs/2026-06-07-canonical-schema-v1-json-load-api.md:634`; `docs/_registry/benchmarks.yaml:694`; `test/benchmarks/benchmark_probe_flutter.dart:2086`; `docs/history/research/2026-06-14-schema-v1-load-read-paths.md:556` | Required proof surfaces; benchmark execution order; benchmark source-of-truth repair |
| D7 | Source-of-truth docs and guardrails must name the canonical reader owner and prevent reintroduction of a second schema v1 traversal. | `docs/contracts/codec_boundary.md:49`; `test/codec/schema_v1_import_emitter_test.dart:22`; `docs/history/research/2026-06-14-schema-v1-load-read-paths.md:530` | `Source-Of-Truth Impact`; docs/guardrail unit; structural regression test |
...
|---|---|---|
| Owner-Level Fix | pass | The duplicated cause is two schema v1 read paths (`docs/history/research/2026-06-14-schema-v1-load-read-paths.md:13`), so the selected form consolidates the owning reader seam instead of editing one call site. |
...
- Evidence to cite:
  `docs/history/research/2026-06-14-schema-v1-load-read-paths.md:13`,
  `docs/history/research/2026-06-14-schema-v1-load-read-paths.md:37`,
