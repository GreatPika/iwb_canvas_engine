...
The geometry corrupted-row routing table row remains deferred after P8 and is
not required for P10 closure. P8 and P10 return sanitized misses for corrupted
geometry rows without allocating DiagnosticsHub records. When a later contract
