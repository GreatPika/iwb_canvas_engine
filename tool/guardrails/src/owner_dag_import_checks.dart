...
const ownerDagAllowedEdges = [
  ...
  OwnerEdge(
    source: runtimeOwner,
    target: spatialOwner,
    sourcePath: 'lib/src/runtime/selection_transform_facts_reader.dart',
    targetPath: 'lib/src/geometry/geometry_policy.dart',
  ),
  OwnerEdge(
    source: runtimeOwner,
  ...
  OwnerEdge(source: storeOwner, target: contractsInternalOwner),
  ...
  OwnerEdge(source: codecOwner, target: contractsInternalOwner),
  ...
  OwnerEdge(
    source: surfaceOwner,
    target: frameOwner,
    sourcePath: 'lib/src/surface/asset_bridge.dart',
    targetPath: 'lib/src/frame/frame_engine.dart',
  ),
  OwnerEdge(
    source: surfaceOwner,
