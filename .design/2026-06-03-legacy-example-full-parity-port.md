...
- `.research/2026-06-03-example-full-parity-before-p14.md` - factual inventory
...
- `.research/2026-06-03-example-full-parity-before-p14.md:13` - the legacy
...
- `.research/2026-06-03-example-full-parity-before-p14.md:15` - the rebuilt
...
- `.research/2026-06-03-example-full-parity-before-p14.md:17` - most user-facing
...
- `.research/2026-06-03-example-full-parity-before-p14.md:25` - legacy `main`
  owns startup and dependency injection -> supports keeping app startup as an
  example-owned responsibility.
- `.research/2026-06-03-example-full-parity-before-p14.md:26` - legacy sample
...
- `.research/2026-06-03-example-full-parity-before-p14.md:27` - legacy view
...
- `.research/2026-06-03-example-full-parity-before-p14.md:28` - legacy controls
  ...
  mappings.
- `.research/2026-06-03-example-full-parity-before-p14.md:29` - legacy screen
...
- `.research/2026-06-03-example-full-parity-before-p14.md:30` - legacy surface
...
- `.research/2026-06-03-example-full-parity-before-p14.md:31` - legacy text
...
- `.research/2026-06-03-example-full-parity-before-p14.md:32` - legacy text
...
- `.research/2026-06-03-example-full-parity-before-p14.md:34` - legacy example
  ...
  future contract.
- `.research/2026-06-03-example-full-parity-before-p14.md:36` - Flutter-only
  ...
  calls.
- `.research/2026-06-03-example-full-parity-before-p14.md:40` - every
...
- `.research/2026-06-03-example-full-parity-before-p14.md:57` - legacy inline
...
- `.research/2026-06-03-example-full-parity-before-p14.md:62` - legacy defaults
...
- `.research/2026-06-03-example-full-parity-before-p14.md:66` - the public barrel
...
- `.research/2026-06-03-example-full-parity-before-p14.md:68` - `CanvasRuntime`
...
- `.research/2026-06-03-example-full-parity-before-p14.md:70` - `CanvasSurface`
  ...
  surface widget.
- `.research/2026-06-03-example-full-parity-before-p14.md:72` - runtime ports
...
- `.research/2026-06-03-example-full-parity-before-p14.md:84` - current public
...
- `.research/2026-06-03-example-full-parity-before-p14.md:187` - current rebuilt
...
- `.research/2026-06-03-example-full-parity-before-p14.md:192` - public consumer
...
- `.research/2026-06-03-example-full-parity-before-p14.md:194` - resource
...
- `.research/2026-06-03-example-full-parity-before-p14.md:195` - text editor UI
  is application-owned after context request delivery -> supports app-owned
  overlay/focus/lifetime.
- `.research/2026-06-03-example-full-parity-before-p14.md:196` - P14 is release
  ...
  port.
- `.research/2026-06-03-example-full-parity-before-p14.md:200` - legacy JSON
...
| The public surface is next-owned and bans legacy public shapes. | `docs/contracts/public_api_v1.md:103`, `.research/2026-06-03-example-full-parity-before-p14.md:34` | Replace legacy controller/spec/patch/codec names with `CanvasRuntime`, public DTOs, `CanvasFieldUpdate`, ports, and schema v1 helpers. | Widget code cannot be copied mechanically; the view model and model types must be rewritten. |
| P14 must not add new engine feature behavior. | `docs/implementation/p14_benchmarks_diagrams_and_release_readiness.md:137`, `.research/2026-06-03-example-full-parity-before-p14.md:196` | Example exposes existing public capabilities; any discovered missing engine capability blocks the contract instead of being bypassed through internals. | If a parity gap appears, implementation pauses for a separate engine contract. |
...
| Resource bytes and image resolution are app-owned and session-bound. | `docs/contracts/resources.md:53`, `docs/contracts/resources.md:67`, `docs/contracts/resources.md:112`, `.research/2026-06-03-example-full-parity-before-p14.md:194` | Keep `SampleImageAssetService` and resolver in example code; pass resolver into `CanvasSurface`. | The example must own asset declaration and image disposal policy without expecting engine IO. |
| Current verification proves public surface behavior but not complete example UI parity. | `docs/verification/tests.md:579`, `.research/2026-06-03-example-full-parity-before-p14.md:187` | Add focused example widget/view-model tests and public-import structural proof. | More tests are needed than the existing coarse smoke test; screenshots/manual run can supplement but not replace automated proof. |
| Legacy JSON payload compatibility is not required. | `.research/2026-06-03-example-full-parity-before-p14.md:200`, `lib/src/api/canvas_codec.dart:7`, `lib/src/api/canvas_codec.dart:13`, user decision on 2026-06-03 | Preserve the import/export workflow using schema v1 and reject legacy payload compatibility for this design. | Users with old copied JSON payloads cannot import them through this example unless a separate migration feature is later approved. |
...
|---|---|---|---|
| D1 | The rebuilt example is a root public-consumer Flutter example, not an engine-side adapter or test-only fixture. | `.research/2026-06-03-example-full-parity-before-p14.md:187`, `docs/implementation/p14_benchmarks_diagrams_and_release_readiness.md:20`, `docs/verification/release_gates.md:235` | `Boundaries.Owner`, `Boundaries.Entry`, `Unit 1` app/package setup, import proof |
...
| D3 | Replace `SceneController` ownership with app-owned `CanvasRuntime` lifecycle and public ports. | `.research/2026-06-03-example-full-parity-before-p14.md:68`, `lib/src/api/canvas_runtime.dart:26`, `lib/src/api/canvas_runtime.dart:39` | `Unit 2` rebuilt view model, runtime lifecycle tests |
| D4 | Replace `SceneView` with public `CanvasSurface`; keep pending-line marker as app overlay derived from public preview state. | `.research/2026-06-03-example-full-parity-before-p14.md:30`, `lib/src/surface/canvas_surface_widget.dart:14`, `test/smoke/public_incremental_smoke_test.dart:920` | `Unit 3` surface/screen mapping, widget proof |
...
| D7 | Preserve JSON import/export workflow using schema v1 document JSON; old legacy scene JSON payload compatibility is not required. | `.research/2026-06-03-example-full-parity-before-p14.md:200`, `lib/src/api/canvas_codec.dart:7`, `lib/src/api/canvas_codec.dart:13`, user decision on 2026-06-03 | `Unit 6` import/export workflow, invalid JSON proof |
| D8 | Future verification must include app-specific widget/view-model parity tests and structural import/retired-symbol checks because existing core guardrails do not scan example code. | `tool/guardrails/src/core_boundary_checks.dart:23`, `docs/verification/tests.md:443`, `.research/2026-06-03-example-full-parity-before-p14.md:187` | `Verification Strategy`, `Unit 7` tests/guard proof |
...
| Ownership | pass | Runtime/surface behavior stays owned by public engine APIs (`lib/src/api/canvas_runtime.dart:39`, `lib/src/surface/canvas_surface_widget.dart:14`); UI, resolver, dialogs, and overlay are app-owned (`.research/2026-06-03-example-full-parity-before-p14.md:36`). |
| Source-Of-Truth Singularity | pass | Public API remains owned by `docs/contracts/public_api_v1.md` and registry (`docs/contracts/public_api_v1.md:88`); parity source input is the research inventory (`.research/2026-06-03-example-full-parity-before-p14.md:40`); future example code owns runnable behavior. |
...
| Sequenced Migration And Retirement | pass | Successor path is `CanvasRuntime`/`CanvasSurface`/public DTOs; retired path is legacy `SceneController`/`SceneView`/legacy patch/spec/codec symbols; retirement gate is structural no-retired-symbol proof plus no legacy imports (`.research/2026-06-03-example-full-parity-before-p14.md:34`, `docs/verification/guardrails.md:185`). |
