...
- `.research/2026-05-19-pointer-tool-cleanup-coordinator.md` - supplied factual
...
- `.research/2026-05-19-pointer-tool-cleanup-coordinator.md:13` - the new
...
- `.research/2026-05-19-pointer-tool-cleanup-coordinator.md:15` - legacy cleanup
  ...
  dispatch.
- `.research/2026-05-19-pointer-tool-cleanup-coordinator.md:17` - legacy
...
|---|---|---|
| Root cause | pass | Repeated cleanup paths exist across generic and tool-specific diagrams, while no durable `docs/` source-of-truth coordinator exists today: `docs/README.md:3`; `docs/README.md:35`; `.research/2026-05-19-pointer-tool-cleanup-coordinator.md:13`. The non-normative root backlog already names `PointerToolCleanupCoordinator` as product context: `todo.md:143`; `todo.md:177`. Tool cleanup repetitions are visible in `docs/diagrams/state_selected_move.mmd:127`, `docs/diagrams/state_select_marquee.mmd:114`, `docs/diagrams/state_pencil_marker_draw.mmd:117`, `docs/diagrams/state_two_tap_line.mmd:110`, and `docs/diagrams/state_eraser.mmd:111`. |
