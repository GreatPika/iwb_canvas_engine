...
- `.research/2026-05-27-cyclic-dependency-anchors.md` - records the current
...
- `.research/2026-05-27-cyclic-dependency-anchors.md:13` - the current source
...
- `.research/2026-05-27-cyclic-dependency-anchors.md:15` - current enforcement
  checks public-API-internal cycles only and explicitly allows the
  `CanvasRuntime -> RuntimeRoot` import.
- `.research/2026-05-27-cyclic-dependency-anchors.md:17` - the same dependency
...
- Evidence to cite:
  - Current cycles: `.research/2026-05-27-cyclic-dependency-anchors.md:13`.
