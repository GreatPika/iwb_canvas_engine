...
POLICY = (
    ...
    "without a new reason. When evaluating options and making recommendations, "
    "account for the project purpose and operating context defined under "
    "`## Repository purpose`. Revise a conclusion only when new facts emerge, "
