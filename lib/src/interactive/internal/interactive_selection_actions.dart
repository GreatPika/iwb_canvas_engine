...
class InteractiveSelectionActionsCallbacks {
  const InteractiveSelectionActionsCallbacks({
...
final class InteractiveSelectionActions {
  const InteractiveSelectionActions({
    required this.core,
    required this.callbacks,
  });

  final SceneControllerCore core;
  final InteractiveSelectionActionsCallbacks callbacks;
  ...
  void _commitTransformSelection(
    ...
    final affected = core.write<int>((writer) {
